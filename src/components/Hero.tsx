  ...
  return (
    <section className="py-20 md:py-32 px-6 lg:px-0">
      <div className="prose-editorial">
        ...
        >
          Product leader building at the intersection of business, design & engineering.
        </motion.h1>
        <motion.p
          initial={{ opacity: 0, y: 8 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          I write about product strategy, service design, and building human-centred solutions for complex systems. Based in London.
        </motion.p>
      </div>
    </section>
  );
